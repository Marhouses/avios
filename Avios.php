...
<br><br><br>
  ...
  <tbody>
    <a class="boton" href="index.php?action=SearchByAvios" style="border: 1px solid #2e518b; /*anchura, estilo y color borde*/
padding: 10px; /*espacio alrededor texto*/
background-color: #2e518b; /*color botón*/
color: #ffffff; /*color texto*/
text-decoration: none; /*decoración texto*/
...
border-radius: 50px; /*bordes redondos*/ margin: 30px auto;
  ...
  width: 100%; cursor: pointer;border: 1px solid #FAFAFA;
    left: 100px;
    margin: 0;">Search window</a> 
    <?php 
	$style= new Controller();
	$style->AviosViewController();
 ?>
  </tbody>
</table>
