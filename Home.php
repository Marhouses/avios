...
<table class="table ">
 ...
 <a class="boton" href="index.php?action=newStyle" style="border: 1px solid #2e518b; /*anchura, estilo y color borde*/
...
<br><br><br>
  ...
  <thead>
    <tr>
      ...
      <th class=idstyle scope="col">#</th>
      <th class=nameStyle scope="col">Name Style</th>
