...
<table class="table ">
 ...
 <a class="boton" href="index.php?action=newLenght" style="border: 1px solid #2e518b; /*anchura, estilo y color borde*/
...
<br><br><br>
  ...
  <thead>
    <tr>
      ...
      <th class=lenght scope="col">Length</th>
        <th class=xs scope="col"> XS</th>
      <th class=s scope="col">S</th>
          <th class=m scope="col"> M</th>
      <th class=l scope="col">L</th>
          <th class=xl scope="col"> XL</th>
      <th class=xxl scope="col">XXL</th>
          <th class=xxx scope="col"> 3X</th>
      <th class=xxxx scope="col">4X</th>
          <th class=xxxxx scope="col"> 5X</th>
