...
<link rel="shortcut icon" href="https://scontent.fntr6-1.fna.fbcdn.net/v/t1.0-9/42586376_270370240255533_2572685912815173632_n.jpg?_nc_cat=108&_nc_ht=scontent.fntr6-1.fna&oh=8d7d3d9fc0e1f5a427426f7dc47933da&oe=5CB3A4FF">
					...
					<input type='number' name='idstyle' placeholder="Write the style" >
<label >Description:</label>
					<textarea id="description" placeholder="Write the status of samples" name="descript" cols="30" rows="5" ></textarea>
					
<label>Supplier:</label>
					<input type='text' name='supplier' placeholder="Write the supplier" >

					<label>Yield:</label>
					<input type='number' name='yield' placeholder="Write the yield" >
					<label>Total Supplier:</label>
					<input type='number' name='totalsupplier' placeholder="Write the price by the supplier" >


					
	

<input type="submit" name="NewAvios" value="Add">
</form>
<?php 
  $objinsert = new Controller();
  $objinsert->insertAviosController();
  ?>